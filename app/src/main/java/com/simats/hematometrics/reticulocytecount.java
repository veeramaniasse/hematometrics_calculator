...
public class reticulocytecount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reticulocytecount);
        reticulocyteEditText = findViewById(R.id.reticulocyte);
        rbcEditText = findViewById(R.id.redcellcount);
    ...
    private void handleResponse(String response) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("true")) {
                ...
                Intent intent = new Intent(reticulocytecount.this, MainActivity2.class);
    ...
    private void calculateReticulocytecount() {
        String reticulocyteStr = reticulocyteEditText.getText().toString();
        String rbcStr = rbcEditText.getText().toString();

        if (!reticulocyteStr.isEmpty() && !rbcStr.isEmpty()) {
            double numberOfReticulocytescountedper1000RBCS = Double.parseDouble(reticulocyteStr);
            double totalNumberOfRBC = Double.parseDouble(rbcStr);
            // Calculate reticulocytecount using the formula
            double reticulocyteCount = (numberOfReticulocytescountedper1000RBCS /totalNumberOfRBC) * 100;
            x=String.format("%.2f", reticulocyteCount);
            outputTextView.setText(String.format("%.2f", reticulocyteCount));
            ...
            outputTextView.setText("Please enter values for Reticulocyte and RBC Count");
